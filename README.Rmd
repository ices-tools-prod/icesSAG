...
![CRAN RStudio mirror downloads](http://cranlogs.r-pkg.org/badges/icesSAG)
![CRAN RStudio mirror downloads](http://cranlogs.r-pkg.org/badges/grand-total/icesSAG)
![CRAN Status](http://r-pkg.org/badges/version/icesSAG)
![CRAN Monthly](http://cranlogs.r-pkg.org/badges/icesSAG)
![CRAN Total](http://cranlogs.r-pkg.org/badges/grand-total/icesSAG)
