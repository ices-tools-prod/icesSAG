...
You can check that the data was uploaded by searching for our stock. Note you will need to make sure use_token is TRUE - I am also switching off messages so as not to show my token ;)
