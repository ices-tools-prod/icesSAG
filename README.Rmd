...
![CRAN Status](https://r-pkg.org/badges/version/icesSAG)
![CRAN Monthly](https://cranlogs.r-pkg.org/badges/icesSAG)
![CRAN Total](https://cranlogs.r-pkg.org/badges/grand-total/icesSAG)
